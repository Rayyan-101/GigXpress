  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_URL}/api/auth/register/${selectedRole}`,
        {
          method: "POST",
        ...
        <header className="p-6 border-b">
          <div className="max-w-7xl mx-auto flex justify-between">
            ...
            <div>
              <button
                onClick={() => navigate("/")}
                className="p-2 flex items-center gap-2 text-slate-500 hover:text-indigo-600 transition-colors duration-200"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full mb-10">
            {roles.map((role) => (
              ...
              >
                ...
                <div
                  className={`mb-4 ${selectedRole === role.id ? "text-indigo-600" : "text-gray-700"}`}
                >
                  {role.icon}
                </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                Create your organizer account to start hiring talent
              </p>
            </div>
        ...
        <main className="max-w-2xl mx-auto px-6 py-12">
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                Create your account to start finding gigs
              </p>
            </div>
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-6">
        <div className="bg-white rounded-2xl shadow-lg p-12 max-w-md w-full text-center">
          ...
          <button
            onClick={() =>
              navigate(
                selectedRole === "organizer" ? "/organizer" : "/volunteer",
              )
            }
