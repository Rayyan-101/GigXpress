  ...
  const features = [
    {
      ...
      description:
        "Your payments are held securely until work is verified. Get paid safely every time.",
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: "KYC Verified Users",
      description:
        "Work with confidence. All users are KYC verified ensuring trust and accountability.",
    },
    {
      icon: <MapPin className="w-8 h-8" />,
      title: "Location-Based Matching",
      description:
        "Find gigs near you. Our smart algorithm matches you with opportunities in your area.",
    },
    {
      icon: <Star className="w-8 h-8" />,
      title: "Rating & Review System",
      description:
        "Build your reputation. Two-way ratings help maintain quality and trust.",
    },
    {
      icon: <Clock className="w-8 h-8" />,
      title: "Flexible Work Schedule",
      description:
        "Work on your terms. Choose gigs that fit your schedule and earn when it suits you.",
    },
    {
      icon: <Award className="w-8 h-8" />,
      title: "Proof of Work Verification",
      description:
        "Upload proof of completed work for quick approval and guaranteed payment.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button className="px-6 py-2.5 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg hover:opacity-90 transition shadow-lg">
                Get Started
              </button> */}
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t">
            <div className="px-4 py-4 space-y-3">
              ...
              <button className="block w-full text-left py-2 text-indigo-600 font-semibold">
                Login
              </button>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-5xl md:text-6xl font-bold mb-6 leading-tight">
                Your Gateway to
                <br />
                <span className="text-yellow-300">Event-Based</span>
                <br />
                Opportunities
              </h1>
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Connect organizers with skilled volunteers. Find gigs, work
                flexibly, and earn securely with our escrow-protected platform.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Everything you need to find, manage, and complete event-based gigs
              successfully
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
            {categories.map((category, index) => (
              <div
                key={index}
                className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl hover:-translate-y-2 transition-all duration-300 cursor-pointer"
              >
      ...
      <section className="py-20 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Join thousands of users earning through flexible gig work
          </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400">
                Your trusted platform for event-based opportunities
              </p>
            </div>
            <div>
